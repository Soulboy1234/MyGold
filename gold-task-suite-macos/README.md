...
This folder provides a macOS-friendly shortcut layer for the existing workspace. It does not replace the Windows scripts in `gold-task-suite`; it mirrors the same responsibilities with `.sh` entry points.
