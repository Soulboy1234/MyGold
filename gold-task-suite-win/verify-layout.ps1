...
$requiredPaths = @(
  ...
  (Join-Path $workspaceRoot "gold-dashboard\versions\V1.2.0"),
  (Join-Path $workspaceRoot "gold-monitor\versions\V1.2.0"),
  (Join-Path $workspaceRoot "gold-investor-agent\versions\V5.0.1"),
