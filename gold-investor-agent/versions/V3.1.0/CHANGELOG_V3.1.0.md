...
1. 运行时稳定性
- [run-daemon.mjs](/D:/codex/gold-investor-agent/shared/runtime/run-daemon.mjs)
...
- [start-dashboard-server.mjs](/D:/codex/gold-investor-agent/shared/runtime/start-dashboard-server.mjs)
...
- 已执行 `node --check`
  ...
  - [app.js](/D:/codex/gold-investor-agent/public/app.js)
- 已执行单次 Agent 运行
  - [src/agent.mjs](/D:/codex/gold-investor-agent/src/agent.mjs)
- 已验证 dashboard 接口
  - `/api/agents`
